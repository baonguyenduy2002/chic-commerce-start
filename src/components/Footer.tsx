...
const Footer: React.FC = () => {
  return (
    <footer id="contact" className="bg-fashion-charcoal text-white">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand */}
          <div className="md:col-span-1">
            <h2 className="font-serif text-xl font-semibold mb-4">ELEGANTE</h2>
            <p className="text-gray-300 mb-4">Premium sustainable clothing for the modern individual.</p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-300 hover:text-white">Women's Collection</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white">Men's Collection</a></li>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">&copy; {new Date().getFullYear()} Elegante. All rights reserved.</p>
